...
export default function Events() {
  ...
  useEffect(() => {
    ...
    // big text is static — ensure it's visible
  ...
  return (
    <section className="events">
      ...
      <div ref={section1Ref} className={styles.eventSection + ' ' + styles.sectionHidden}>
        ...
        <div className={styles.bigTextFull}><span ref={bigTextRef} className={styles.bigTextInner}>CELEBRATE CONNECT COLLABORATE JOIN US TONIGHT</span></div>
      </div>
